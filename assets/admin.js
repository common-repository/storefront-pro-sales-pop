...
jQuery(function($) {
  sfpSkins.$orle = $('#sfp-sales-pop-overlay');
  sfpSkins.$dlg = $('#sfp-sales-pop-dialog');
  sfpSkins.$wrap = $('#sfp-sales-pop-wrap');
  sfpSkins.$skinApplyConfirmDialog = $('#sfp-sales-pop-apply-confirm');
  ...
  sfpSkins.notice = function(message) {
    ...
    $('#sfp-sales-pop-notice').html('<div id="sfp-sales-pop-notice-message">' + message + '</div>').fadeIn(250);
    return setTimeout(function() {
      return $('#sfp-sales-pop-notice').html('').fadeOut(250);
    }, 1100);
  };
  ...
  sfpSkins.saveSkinButton = function() {
    ...
    skinName = $('#sfp-sales-pop-skin-name').val();
    $('#sfp-sales-pop-skin-name').val('');
    if ('string' === typeof sfpSkins.renameSkin) {
      ...
      $('#sfp-sales-pop-save-skin').text('Save skin');
  ...
  sfpSkins.doubleClickedSkin = function(e) {
    ...
    $('#sfp-sales-pop-skin-name').val(sfpSkins.renameSkin);
    $('#sfp-sales-pop-save-skin').text('Rename');
    return sfpSkins.showSaveDlg();
  };
  sfpSkins.prepMaps();
  $('#customize-header-actions').after($('#sfp-sales-pop-actions'));
  $('#sfp-sales-pop-save-dialog').click(sfpSkins.showSaveDlg);
  $('#sfp-sales-pop-save-skin').click(sfpSkins.saveSkinButton);
